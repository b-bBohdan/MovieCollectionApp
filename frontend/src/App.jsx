...
import ProfilePage, { loader as ppLoader } from "./pages/ProfilePage";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "add", element: <AddMoviePage />, action: addAction },
      {
        path: ":id",
        children: [
          {
      ...
      { path: "register", element: <AuthenticationPage />, action: authAction },
      {
        path: "profile",
        element: <ProfilePage />,
        loader: ppLoader,
